...
public class Content extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        Cursor c = null;
        c = sqLiteDatabase.query(DataContract.DataEntry.TABLE_NAME, null, selection, selectionArgs, null, null, null);
        return c;
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        sqLiteDatabase.insert(DataContract.DataEntry.TABLE_NAME, null, values);
        return null;
    }
