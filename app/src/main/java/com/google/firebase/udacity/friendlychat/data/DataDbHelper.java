    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE =
                 ...
                 */
                        ...
                        DataContract.DataEntry.AudioId + " STRING NOT NULL, " +

                        DataContract.DataEntry.AudioPath + " STRING NOT NULL," +

                        DataContract.DataEntry.AudioLink + " STRING NOT NULL, " +
...
//              COMPLETED (1) Add a UNIQUE constraint on the date column to replace on conflict
                 ...
                 */
                        " UNIQUE (" + DataContract.DataEntry.AudioLink + ") ON CONFLICT REPLACE);";
